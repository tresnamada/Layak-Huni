    ...
    <main className="relative w-full h-screen bg-[#F6F6EC] overflow-hidden" ref={containerRef}>
      ...
      <div className="absolute inset-0 w-full h-full">
        <motion.div
          ...
          // Initial scale and opacity for entry animation
          ...
          >
            <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-20 pb-4 sm:pb-8 md:pb-12 lg:pb-20">
              <motion.div
                ...
                variants={stagger}
                initial="hidden"
                animate="visible" // Trigger animations on mount
              >
                {/* Top Section - Project Info */}
                <motion.div className="flex flex-col gap-1 sm:gap-2" variants={fadeInUp}>
                  <motion.span
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  ...
                  <motion.div className="max-w-[85%] sm:max-w-[75%] md:max-w-xl lg:max-w-2xl" variants={fadeInUp}>
                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-tight tracking-tight drop-shadow-md">
                      ...
                      <motion.span className="block text-amber-100/90" variants={fadeInUp}>
                        Tanpa Proses Ribet
                      </motion.span>
                    </h1>
                  </motion.div>
                  {/* Right side - Subtext and CTA */}
                  <motion.div className="flex flex-col items-start gap-3 sm:gap-4 w-full md:w-auto" variants={fadeInUp}>
                    <motion.p
