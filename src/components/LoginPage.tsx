      ...
      >
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 bg-[#594C1A]/40 flex items-center justify-center">
              ...
              >
                ...
                <p className="text-lg">Your property solution</p>
              </motion.div>
            </div>
          </div>
        </motion.div>
        ...
        <div className='w-full md:w-1/2'>
          <div className='p-6 bg-[#594C1A] text-white'>
            ...
            <p className='text-center text-[#EAF4DE]/80 mt-1'>Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className='p-6 space-y-4'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <div className='text-sm'>
                <a href='#' className='font-medium text-[#938656] hover:text-[#594C1A]'>
                  Forgot password?
                </a>
              </div>
            </div>
